		...
		<div class="header_middle">
            ...
            <div id="custom-search-input">
                <div class="input-group col-md-12">
                    <input type="text" class="form-control input-lg" placeholder="NHẬP SẢN PHẨM" />
        ...
        <div class="container content">
                <div class="col-md-2 supplier">
                    ...
                    <div class="nav nav-pills nav-stacked">
						...
						<div class="menu-left">
                    <div class="nav nav-pills nav-stacked">
                    	<li  class="active"><a href="#">HÃNG SẢN XUẤT</a></li>  
               ...
               <div class="col-md-10">
                ...
                <c:forEach var="phone" items="${detailpr.listproduct }" varStatus="status">
             <div class="col-sm-4">
